...
INSERT INTO Usuarios (username, email, password, first_name, last_name, is_staff, is_active, is_superuser, last_login, date_joined)
VALUES 
	('Lucas', 'lucas@email.com', 'lucas123', '', '', 1, 1, 1, NOW(), NOW()),
    ('Lindomar', 'lin@email.com', 'lin12345', '', '', 0, 1, 0, NOW(), NOW()),
    ('Fernanda', 'fer@email.com', 'fer12345', '', '', 0, 1, 0, NOW(), NOW());
...
INSERT INTO Historicos (data_historico, responsavel, produto)
VALUES
    ('2025-10-30', 1, 1),
    ('2025-05-25', 1, 2),
    ('2025-07-18', 1, 3);
