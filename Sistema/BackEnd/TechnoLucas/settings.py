"""
Django settings for TechnoLucas project.
...
SECRET_KEY = 'django-insecure-$@i_)b2%6ohui=-7p-quzhb)nlqmh3=*knqt@i2b#41ge78oo0'
...
WSGI_APPLICATION = 'TechnoLucas.wsgi.application'
